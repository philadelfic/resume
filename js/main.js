...
const TRANSLATIONS = {
    ru: {
        ...
        'about.title': 'Обо мне',
        'about.p1': 'ИТ-лидер команды разработки с общим опытом работы 8+ лет, из которых 4 года в ИТ. Специализируюсь на управлении командами разработки, ведении проектов (новых систем и сервисов), системном анализе, импортозамещении и внедрении AI-инструментов.',
        'about.p2': 'Текущие проекты — вывод новых банковских кадровых сервисов и перевод существующих на отечественный стек. Управляю командой из 16+ человек: архитекторы, системные аналитики, разработчики, тестировщики и DevOps. Внедрил релизную политику, менторю новых специалистов и веду проекты.',
        'about.p3': 'Постоянно тестирую новые технологии на собственном homelab из 5 серверов — до внедрения в стек организации. Уверенно правлю код — Web (HTML/CSS/React), Python, JavaScript. Автоматизирую рабочие процессы на Python/JS: интеграции с LLM API, обработка данных для AI-пайплайнов. Есть MVP AI-инструмента, доведённый до продакшна.',
        'about.p4': 'Защитил магистерскую диссертацию на тему «Социально-экономические последствия развития Цифровой экономики», рекомендован к аспирантуре. Продолжаю изучать эту тему для применения в работе.',
        'about.resultsTitle': 'Ключевые результаты',
        'about.r1': 'Банковские кадровые сервисы: 65 сервисов вывел в выделенный раздел корпоративного портала, 15 — в мобильное приложение; 80 тыс. пользователей, 90% сотрудников заходят ежемесячно (MAU), 10–17 тыс. ежедневно (DAU), снижение обращений в HR в 8 раз',
        ...
        'about.r4': 'Автоматизация: n8n — множество интеграций, ~12 ч/нед. экономии в своей работе; рассказываю команде о технологиях автоматизации и помогаю с настройкой — каждый умеет автоматизировать свою рутину',
        ...
        'exp1.li1': 'Дополнительно выполняю роль системного аналитика в системе аутентификации пользователей',
        ...
        'exp1.ach1': 'Масштабирование: вывел 65 HR-сервисов в выделенный раздел корпоративного портала, 15 — в мобильное приложение; 80 тыс. пользователей, ежемесячно — 90% сотрудников, ежедневно 10–17 тыс. Снизил ручные обращения в HR в 8 раз',
        'exp1.ach6': 'Импортозамещение: перешёл с FIORI/OData на REST/Kafka, мигрировал на Astra Linux, развил микросервисную архитектуру — подготовил платформу к AI-внедрениям',
        ...
        'exp1.ach5': 'Метрики и документация: внедрил MAU/WAU/DAU, мониторинг сценариев и ошибок — решения на основе данных; обеспечил безопасную работу со знаниями и персональными данными (152-ФЗ) в контуре, создал видео-инструкции для сложных сервисов',
        ...
        'exp3.ach1': 'Провёл оптимизацию структуры подведомственных учреждений',
        'exp3.ach2': 'Внедрил YouGile для учёта задач и нарушений',

        'exp4.role': 'Предыдущий опыт',
        'exp4.date': 'Ноябрь 2016 — Июнь 2020',
        'exp4.li1': 'ФГБУ «Центр спортивной подготовки сборных команд России», куратор паралимпийских команд (подготовка к Паралимпийским играм Tokyo 2020)',
        ...
        'edu.main.title': 'Основное образование',
        'edu.additional.title': 'Дополнительное образование',
    ...
    en: {
        ...
        'about.p2': 'Current projects — launching new banking HR services and migrating existing ones to a domestic (sovereign) stack. I manage a team of 16+: architects, system analysts, developers, QA, and DevOps. Introduced a release policy, mentor new specialists, and run the projects end-to-end.',
        'about.p3': "I constantly test new technologies on my own 5-server home lab — before bringing them into the organization's tech stack. I confidently fix and refine code — Web (HTML/CSS/React), Python, JavaScript. I automate my workflows with Python/JS: LLM API integration scripts, AI pipeline data processing. Shipped an MVP of an AI tool to production.",
        'about.p4': "Defended a master's thesis on «Socio-economic consequences of the Digital economy development»; recommended for postgraduate studies. I keep studying this topic to apply it in my work.",
        'about.resultsTitle': 'Key results',
        'about.r1': 'Banking HR services: brought 65 services into a dedicated section of the corporate portal, 15 — into the mobile app; 80k users, 90% of employees visit monthly (MAU), 10–17k daily (DAU), 8× fewer HR tickets',
        'about.r2': 'Import substitution (migration to a sovereign tech stack): FIORI/OData → REST/Kafka + Astra Linux, move to microservices',
        'about.r3': 'AI infrastructure: local LLMs (Ollama/vLLM), MCP, RAG — a 16-person team uses AI daily',
        'about.r4': 'Automation: n8n — many integrations; ~12 hours/week saved in my own work; I coach the team on automation tech and help with setup so everyone can automate their own routine',
        ...
        'exp1.li1': 'Also act as the system analyst on the user authentication system',
        ...
        'exp1.ach1': 'Scale-up: brought 65 HR services into a dedicated section of the corporate portal, 15 — into the mobile app; 80k users, 90% of employees visit monthly, 10–17k daily. Cut manual HR tickets 8×',
        'exp1.ach6': 'Import substitution: moved from FIORI/OData to REST/Kafka, migrated to Astra Linux, grew the microservice architecture — prepped the platform for AI adoption',
        ...
        'exp1.ach5': 'Metrics & documentation: introduced MAU/WAU/DAU, scenario and error monitoring — data-driven decisions; organized secure in-perimeter knowledge work and personal data handling (152-FZ), created video guides for complex services',
        ...
        'exp3.ach1': 'Ran structural optimization of subordinate institutions',
        ...
        'exp4.li1': 'Federal Center for Sports Training of Russian National Teams, curator of Paralympic teams (preparation for the Tokyo 2020 Paralympic Games)',
        ...
        'edu.main.title': 'Main education',
        'edu.additional.title': 'Additional education',
        ...
        'proj1.name': 'LLM Second Brain',
        'proj1.desc': 'Self-hosted MCP "second brain" server for LLMs: gives models (Open WebUI and others) a shared note bank with hybrid search — vector and full-text. Knowledge lives apart from chat history; the model gets only what is relevant.',
